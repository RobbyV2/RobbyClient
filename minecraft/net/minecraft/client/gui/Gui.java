...
public class Gui
{
     ...
     */
    public static void drawRect(int left, int offset, int right, int d, int color)
    {
        int var5;
	...
	public static void drawRect(int left, double offset, int scaledWidth, double d, int color) {
